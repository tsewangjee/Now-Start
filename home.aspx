...
<body>
    <form id="form1" runat="server">  
       <div> 
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
              <asp:Button ID="Button3" runat="server" Text="SELL" OnClick="Button3_Click" style="margin-left: 330px;" BackColor="#FFCC66" Height="40px" float="right" Width="97px"/>
        ...
        <ul>
            ...
            <div>
                ...
                <asp:Button ID="Button4" CssClass="bttn" runat="server" BackColor="darkred"
                    ...
                    Height="25px" Text="Search" Width="80px" ForeColor="White" />
                </div></div>
        </section>
